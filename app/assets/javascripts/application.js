...
function createMovie() {
    ...
    year = $('#movie-year').val()
    rating = $('input[name=star]:checked', '#create-movie-form').val()
    if (title == "" || actors == "" || genre == "" || year == "" || rating == ""){
    ...
    success: function(data) {
      ...
      $('#create-error-msg').css("display","none");
          ...
          create_html += 'Succesfully saved ' + data.title + '. Saving to movie list. . . '
          create_html += '</div>'
          create_html += '<table class="table">'
          create_html += '<thead>'
          create_html += '<tr>'
          create_html += '<th>Title</th>'
          create_html += '<th>Actors</th>'
          create_html += '<th>Genre</th>'
          create_html += '<th>Year</th>'
          create_html += '<th>Rating</th>'
          create_html += '</tr>'
          create_html += '</thead>'
          create_html += '<tbody>'
          create_html += '<tr>'
          create_html += '<td>' + data.title +'</td>'
          create_html += '<td>' + data.actors + '</td>'
          create_html += '<td>' + data.genre + '</td>'
          create_html += '<td>' + data.year + '</td>'
          create_html += '<td>' + data.rating + '</td>'
          create_html += '</tr>'
          create_html += '</tbody>'
          create_html += '</table>'
